...
public record EchoNativeAgent3RuntimeCoreResult(
    ...
    public boolean contractReady() {
        return adapterCoreBridge
                ...
                && Integer.valueOf(95).equals(fullCatalogEvidence.get("descriptorCount"))
                && Integer.valueOf(85).equals(fullCatalogEvidence.get("runtimeActive"))
                && Integer.valueOf(6).equals(fullCatalogEvidence.get("runtimeToolingOnly"))
                ...
                && Integer.valueOf(8).equals(fullCatalogEvidence.get("systemModuleCount"))
                && "runtime-tooling-only".equals(requiredSystemModuleStatuses.get("echomodpackcommandcenter"))
